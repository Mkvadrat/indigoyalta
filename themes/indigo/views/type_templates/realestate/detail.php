...
<?php
	...
	$sharer_links = settings('yandex_share_block_links');
?>
	...
	<div class="estate-title">
		...
		<div class="sharer">
			<?php if(!empty($sharer_links)){ ?>
				<div class="social_button"><div class="ya-share2" data-services="<?php echo $sharer_links;?>"></div></div>
			<?php } ?>
	...
	<div class="estate-photos">
		...
		?>
			<li><a href="<?php echo $photofull; ?>" data-rel="prettyPhoto[<?php echo $recordid; ?>]"><img src="<?php echo $photosrs;  ?>"  alt="<?php if(!empty($alt)){ echo $alt; }else{ echo $cleantitle; } ?>" ></a></li>
		<?php } ?>
		</ul>
	<div class="clear"></div>
	</div>
