...
*/
$config['records_per_page'] = 2;

/* FRAMEWORK PATH
 * The library path where Fastcms classes are stored
 */
if (!defined('FASTCMSLIB'))
{
	define('FASTCMSLIB', APPPATH . 'libraries' . $sep . FASTCMS . $sep);
}
 ...
 * CACHE FOLDER
 */
$config['fr_cache_folder'] = USERPATH . 'cache' . $sep . '_' . FASTCMS. $sep;
 ...
 * TEMPLATES DIRECTORY
 */
$config['templates_folder'] = FASTCMSLIB . 'templates' . $sep;
 ...
 * The .php templates that will be copied from templates to the website theme.
 */
...
$config['page_extract_columns'] = array(
	'id_record', 'uri', 'full_uri', 'title', 'id_parent', 'show_in_menu', 'show_in_menu_rent', 'priority'
);
