...
class Fastcms_Lang extends CI_Lang {
	...
	/**
     * Loads the languages from the Fastcms config file
     */
    ...
    function load_gettext()
    {
        ...
        if (!function_exists('bindtextdomain')) {
            die('Gettext library is required. Please enable it before using Fastcms!');
        }

		// Specify location of translation tables
		bindtextdomain(FASTCMS, $this->gettext_path);
		bind_textdomain_codeset(FASTCMS, 'UTF-8');
