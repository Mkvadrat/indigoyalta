...
<div class="block withsidebar">
	...
	<div class="block_content">
		...
		<div class="sidebar_content" id="html">
			...
			echo form_submit(array('name' => 'html-submit', 'class' => 'submit mid', 'onclick' => "fastcms.blocks.save_section('#html');"), 'Add');
			echo form_close();
			?>
		</div>
		...
		<div class="sidebar_content" id="code">
			...
			echo form_submit(array('name' => 'code-submit', 'class' => 'submit mid', 'onclick' => "fastcms.blocks.save_section('#code');"), 'Add');
			echo form_close();
			?>
		</div>
