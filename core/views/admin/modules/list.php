<div class="block">
	...
	<div class="block_content">
		...
		<div class="internal_padding">
			...
			<form action="" method="post" enctype="multipart/form-data">
				<input type="file" name="package" /><input type="submit" class="submit tiny" value="Установить" />
			</form>
		</div>
		<hr />
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="sortable" id="installed-modules">
				<thead>
					<tr>
						...
						<?php /*?><th><?php echo _('Documentation'); ?></th><?php */?>
				...
				<tbody>
						...
						<tr data-key="<?php echo $module; ?>">
							...
							<?php /*?><td><a href="<?php echo admin_url('modules/docs/'.$module); ?>"><?php echo _('View'); ?></a></td><?php */?>
	...
	<?php /*?>	<div class="internal_padding">
			<h3><img align="absmiddle" src="<?php echo site_url(THEMESPATH . 'admin/widgets/icns/resources.png'); ?>" border="0" alt=""/> <?php echo _('Available modules on Fastcms Modules Repository'); ?></h3><hr />
