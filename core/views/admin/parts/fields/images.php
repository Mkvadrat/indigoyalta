<?php
				...
				if ($count < $field['max']) {
					echo form_upload($attributes).$this->lang->_trans('Максимальное количество для загрузки - %n', array('n' => $field['max']));
...
//					echo '</pre>';
					foreach ($field_value as $image) {
						...
						echo '<div class="uploaded-image-item"><div class="uii-inner"><div class="i-item"><img src="'. attach_url($src) . '" alt="" border="0" /></div>'
