	...
	$.prompt.addState = function(statename, stateobj, afterState) {
		...
		for(k in stateobj.buttons){
			...
			if(typeof v === 'object'){
				...
				state += '" name="' + opts.prefix + '_' + statename + '_button' + ru2en.translit(v.title) + '" id="' + opts.prefix + '_' + statename + '_button' + ru2en.translit(v.title) + '" value="' + v.value + '">' + v.title + '</button>';
				
			} else {
				state += '<button class="'+ $.prompt.currentPrefix + 'button '+ opts.classes.button +' '+ defbtn +'" name="' + opts.prefix + '_' + statename + '_button' + k + '" id="' + opts.prefix +  '_' + statename + '_button' + ru2en.translit(k) + '" value="' + v + '">' + k + '</button>';
