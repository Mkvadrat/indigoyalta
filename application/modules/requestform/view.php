...
<div class="requestform-outer">
	...
	<p>
    	...
    	<li><input name="dealtype" id="dealtype-3" class="fast-radio" type="radio" value="e"> <label for="dealtype-3" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Обменять</label></li>
    	<li><input name="dealtype" id="dealtype-4" class="fast-radio" type="radio" value="r"> <label for="dealtype-4" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Снять</label></li>
    	<li><input name="dealtype" id="dealtype-5" class="fast-radio" type="radio" value="o"> <label for="dealtype-5" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Сдать</label></li>
    </ul>
	</p>
    ...
    <input type="text" name="objectid" class="width-100" />
	</p>
