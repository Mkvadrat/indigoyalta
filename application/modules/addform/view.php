...
<div class="requestform-outer">
	...
	<p>
    	...
    	<li><input name="dealtype" id="dealtype-1" class="fast-radio" type="radio" value="s"> <label for="dealtype-1" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Продать</label></li>
    	<li><input name="dealtype" id="dealtype-2" class="fast-radio" type="radio" value="e"> <label for="dealtype-2" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Обменять</label></li>
    	<li><input name="dealtype" id="dealtype-3" class="fast-radio" type="radio" value="o"> <label for="dealtype-3" class="fast-label<?php echo(form_error('dealtype')?' label-error':'')?>">Сдать</label></li>
    </ul>
	</p>
